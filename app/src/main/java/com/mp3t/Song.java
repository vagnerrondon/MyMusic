...
//	private Image thumbnail;
	...
	public Song(String fileLocation, View display) throws IOException, UnsupportedTagException, InvalidDataException, CannotReadException {
	 ...
	 * @throws UnsupportedTagException 
	 * @throws CannotReadException */
	public Song(File file, View display) throws IOException, UnsupportedTagException, InvalidDataException, CannotReadException {
		this(file, DEFAULT_SORT_ORDER, DEFAULT_IMAGE_WIDTH, display);
	}
	
	public Song(String fileLocation, double imageWidth, View display) throws IOException, UnsupportedTagException, InvalidDataException, CannotReadException {
		this(new File(fileLocation), DEFAULT_SORT_ORDER, imageWidth, display);
	}
	
	public Song(File file, double imageWidth, View display) throws IOException, UnsupportedTagException, InvalidDataException, CannotReadException {
	 ...
	 * @throws UnsupportedTagException 
	 * @throws CannotReadException */
	public Song(String fileLocation, byte[] sortOrder, double imageWidth, View display) throws IOException, UnsupportedTagException, InvalidDataException, CannotReadException {
	 ...
	 * @throws UnsupportedTagException 
	 * @throws CannotReadException */
	public Song(File file, byte[] sortOrder, double imageWidth, View display) throws IOException, UnsupportedTagException, InvalidDataException, CannotReadException {
		this.file = file;
		...
		if (image != null) {
			...
			try {
				...
				thumbnail = new Bitmap(display, imageData);
